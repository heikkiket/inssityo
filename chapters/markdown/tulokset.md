...
![\label{rakkine_default-view}Laskujen lisäysnäkymä](illustration/screenshots/Laskurakkine.png){ height=60% }
...
![\label{rakkine_list-view}Ohjelman listanäkymä](illustration/screenshots/List-view.png){ height=60% }

![\label{rakkine_credited}Ohjelma näyttää, että yksittäinen laskurivi on hyvitetty](illustration/screenshots/credited.png){ height=60% }

Kuvassa \ref{rakkine_credited} on esitetty miten ohjelma näyttää hyvitetyn laskurivin.

![\label{rakkine_dividing}Esimerkki käynnin jakamiesta usealle maksajalle](illustration/screenshots/Dividing.png){ height=60% }
...
![\label{finalmodel1-again}Lopullinen malli](illustration/malli4.jpg){ height=30% }
...
![\label{finalidea1}Idea 1](illustration/final-idea-1.jpg){ height=30% }
...
![\label{finalidea2}Idea 2](illustration/final-idea-2.jpg){ height=30% }
