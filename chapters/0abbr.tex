...
\newglossaryentry{repository}{name=repositorio, description=rajapinta tiedon tallennusvälineeseen}
\newglossaryentry{factory}{name=tehdas-olio, description={olio, joka vastaa toisten olioiden luomisesta}}